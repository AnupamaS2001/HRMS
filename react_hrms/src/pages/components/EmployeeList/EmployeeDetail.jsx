...
import { getEmployeeDetail, updateEmployee, getEmployeeList } from "../../../store/employeeList";
...
const EmployeeDetail = ({ employee }) => {//eslint-disable-line
  ...
  const handleDelete = () => {
    deleteEmployee(employee_detail.id, 
      (data) => {
  ...
  <div>
    ...
    <Container maxWidth="sm" sx={{ mt:0 ,  }} position="center" alignItems="center" justifyContent="center"> 
      <Paper elevation={3} sx={{ p: 3 }}>
        ...
        <Button variant="contained" color="error" text-align="align-right" onClick={handleDelete}>Delete</Button>
        </div>
        ...
        <Dialog open={open} onClose={handleClose}>
          ...
          <DialogActions>
            ...
            <Button onClick={()=>{handleSave(employee_detail?.id);handleClose();}}>Save</Button>
          </DialogActions>
        </Dialog>
        <Divider sx={{ my: 2 }} />
        <Box sx={{ mt: 2 }}>
